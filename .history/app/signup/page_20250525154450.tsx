...
export default function Signup() {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      await saveUser(userCredential.userId, { email, createdAt: new Date() });
      setUser({ id: userCredential.userId, email: userCredential.email ?? undefined } as User); // <-- Type-cast as User
      router.push('/');
    } catch (err: any) {
      const errorMessage = {
